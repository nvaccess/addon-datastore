...
A path to the nvdaAPIVersions, see the schema: [`nvdaAPIVersions.schema.json`](./src/validate/nvdaAPIVersions.schema.json) and current values [`nvdaAPIVersions.json`](./nvdaAPIVersions.json).
...
The transformation creates a projection of the add-on metadata for each [NVDA Add-on API Version](./nvdaAPIVersions.json).
...
The next API version introduced was 2019.3 in the [NVDA commit `899528849792e79b97d67de179f7473cee06b849`](https://github.com/nvaccess/nvda/commit/899528849792e79b97d67de179f7473cee06b849).
