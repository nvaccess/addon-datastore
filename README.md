...
[This is the process NV Access follows](./docs/dev/submissionReview.md#approving-an-author-to-submit-to-a-particular-add-on-id-for-the-first-time).
...
NVDA also allows local installation from a `*.nvda-addon` file.
The data hosted here is distributed under the [ODC-PDDL](https://opendatacommons.org/licenses/pddl/1-0/) license.
[Plain language summary of ODC-PDDL](https://opendatacommons.org/licenses/pddl/summary/).
